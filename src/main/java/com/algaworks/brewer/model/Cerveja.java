...
public class Cerveja implements Serializable {
	...
	@Size(min = 3, max = 50, message = "O nome deve estar entre 3 e 50")
	private String nome;
	...
	@DecimalMin("0.01")
	@DecimalMax(value="9999999.99", message="O valor da cerveja dever ser menor que R$ 9.999.999,99")
	private BigDecimal valor;
	
	@NotNull(message="O teor alcóolico é obrigatório")
	@DecimalMax(value="100.0", message="O valor do teor alcóolico dever ser menor que 100")
	...
	// para gravar a Letra do SKU Maiscula //
	@PrePersist
	@PreUpdate
